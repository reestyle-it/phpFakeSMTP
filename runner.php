...
$config = require './config/runner.php';

$streamContext = $config['stream_context'];
...
$header = true;
$address = ['settings']['host']; //smtp.goodsane.com
...
function updateDb(string $ip, ?string $from = null, ?string $body = null, ?string $subject = null)
{
